import type { Auth, AuthRequest, Session } from 'lucia';
...
export type RequestContext<TBody = unknown> = {
  ...
  user?: { id: string; email?: string; isService?: boolean };
  body?: TBody;
...
export type Middleware<TBody = unknown> = (
  ...
  next: (context: RequestContext<TBody>) => Promise<ApiResponse<unknown> | Response>,
